...
1. [D3 assessment preparation](#d3-assessment-preparation)
2. [Inversion of Control](#inversion-of-control)
3. [Inversion of Control in my take](#inversion-of-control-in-my-take)
4. [Dependency Injection / Dependency inversion](#dependency-injection--dependency-inversion)
5. [SOLID Principles](#solid-principles)
6. [Java design patterns](#java-design-patterns)
7. [Brooks law](#brooks-law)
8. [Spring containers](#spring-containers)
9. [Spring Beans](#spring-beans)
10. [Instantiating a spring container](#instantiating-a-spring-container)
11. [Bean overview](#bean-overview)
12. [Naming beans](#naming-beans)
13. [Aliasing a bean outside the bean definition](#aliasing-a-bean-outside-the-bean-definition)
14. [Instantiating beans](#instantiating-beans)
15. [Enterprise Bean overview](#enterprise-bean-overview)
16. [What is an Enterprise Bean](#what-is-an-enterprise-bean)
17. [Benefits of Enterprise Beans](#benefits-of-enterprise-beans)
18. [What is a session bean](#what-is-a-session-bean)
19. [Types of session beans](#types-of-session-beans)
20. [Stateful session beans](#stateful-session-beans)
21. [Stateless session beans](#stateless-session-beans)
22. [Singleton session beans](#singleton-session-beans)
23. [When to use session beans](#when-to-use-session-beans)
24. [Spring bean scopes](#spring-bean-scopes)
...
31. [Difference between Spring and SpringBoot](#difference-between-spring-and-springboot)
32. [Spring](#spring)
33. [Spring boot](#spring-boot)
34. [SOAP-VS-REST](#soap-vs-rest)
35. [SOAP](#soap)
36. [SOAP advantages](#soap-advantages)
37. [SOAP disadvantages](#soap-disadvantages)
38. [REST](#rest)
39. [The 6 guiding principles of REST](#the-6-guiding-principles-of-rest)
40. [Java Memory Model](#java-memory-model)
41. [Introduction:](#introduction)
42. [Stack memory in Java](#stack-memory-in-java)
43. [Key features of stack memory](#key-features-of-stack-memory)
44. [Heap space in java](#heap-space-in-java)
45. [Key features of java heap memory](#key-features-of-java-heap-memory)
46. [Difference between Java Heap Space and Stack memory](#difference-between-java-heap-space-and-stack-memory)
47. [Memory Management in Java - Young Generation](#memory-management-in-java---young-generation)
48. [Memory management in Java - Old Generation](#memory-management-in-java---old-generation)
49. [Stop the World Event](#stop-the-world-event)
50. [Permanent Generation](#permanent-generation)
51. [Method Area](#method-area)
52. [Memory Pool](#memory-pool)
53. [Runtime Constant Pool](#runtime-constant-pool)
54. [Java Heap Memory Switches](#java-heap-memory-switches)
55. [Java Garbage collection type](#java-garbage-collection-type)
56. [Garbage collection in Java](#garbage-collection-in-java)
57. [How automatic garbage collection works](#how-automatic-garbage-collection-works)
58. [Generational garbage collection](#generational-garbage-collection)
59. [The CMS collector](#the-cms-collector)
60. [G1 collector](#g1-collector)
61. [Java 8 PermGen and Metaspace](#java-8-permgen-and-metaspace)
62. [Polymorphism](#polymorphism)
63. [Compile time polymorphism](#compile-time-polymorphism)
64. [Runtime polymorphism (Dynamic Polymorphism)](#runtime-polymorphism-dynamic-polymorphism)
65. [V-table (Virtual method table)](#v-table-virtual-method-table)
66. [How does it work?](#how-does-it-work)
67. [Java and V-tables](#java-and-v-tables)
68. [What is java reflection?](#what-is-java-reflection)
69. [The four fundamental principles of Object-Oriented Programming](#the-four-fundamental-principles-of-object-oriented-programming)
70. [SDLC](#sdlc)
71. [Different phases in SDLC](#different-phases-in-sdlc)
72. [Importance of following a structured SDLC approach](#importance-of-following-a-structured-sdlc-approach)
73. [What is Software Testing Life Cycle?](#what-is-software-testing-life-cycle)
74. [Different phases in STLC](#different-phases-in-stlc)
75. [Relationship between SDLC and STLC](#relationship-between-sdlc-and-stlc)
76. [CI-CD](#ci-cd)
77. [Continuous software delivery](#continuous-software-delivery)
78. [Continuous software deployment](#continuous-software-deployment)
79. [Collections](#collections)
80. [ArrayList](#arraylist)
81. [LinkedList](#linkedlist)
82. [HashSet](#hashset)
83. [LinkedHashSet](#linkedhashset)
84. [TreeSet](#treeset)
85. [ArrayDequeue](#arraydequeue)
86. [PriorityQueue](#priorityqueue)
87. [HashMap](#hashmap)
88. [LinkedHashMap](#linkedhashmap)
89. [TreeMap](#treemap)
90. [Thread-Safe variants](#thread-safe-variants)
91. [Java-Streams](#java-streams)
92. [What are Java Streams](#what-are-java-streams)
93. [Capabilities of Java Streams](#capabilities-of-java-streams)
94. [Key stream operations](#key-stream-operations)
95. [When to use streams](#when-to-use-streams)
96. [Common stream operations and usage:](#common-stream-operations-and-usage)
97. [What is method reference](#what-is-method-reference)
98. [Method references with streams](#method-references-with-streams)
99. [Examples of method references](#examples-of-method-references)
100. [Map-deep-dive](#map-deep-dive)
101. [Java maps](#java-maps)
102. [How HashMap works](#how-hashmap-works)
103. [Senior-Interview-questions](#senior-interview-questions)
104. [Senior-Springboot-Question](#senior-springboot-question)
